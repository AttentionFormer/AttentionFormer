...
from layers.AutoCorrelation import AutoCorrelation, AutoCorrelationLayer,RAttentionLayer
    ...
    def __init__(self, configs):
        ...
        if configs.version == 'Wavelets':
            ...
            decoder_self_att = FourierBlock(in_channels=configs.d_model,
                                            ...
                                            modes=configs.modes,
                                            mode_select_method=configs.mode_select)
            decoder_self_att2 = FourierBlock(in_channels=configs.d_model,
                                            out_channels=configs.d_model,
                                            seq_len=self.seq_len//2+self.pred_len,
                                            modes=configs.modes,
                                            mode_select_method=configs.mode_select)
            decoder_cross_att = FourierCrossAttention(in_channels=configs.d_model,
                                                      out_channels=configs.d_model,
                                                      seq_len_q=(self.seq_len//2+self.pred_len)//1,
                                                      seq_len_kv=self.seq_len//1,
                                                      modes=configs.modes,
                                                      mode_select_method=configs.mode_select)
